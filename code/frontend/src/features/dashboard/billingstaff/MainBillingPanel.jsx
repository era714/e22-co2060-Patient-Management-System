...
export default function MainBillingPanel({ setActiveSection }) {
  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          <h1 className="text-2xl font-bold text-slate-900 tracking-tight">Process Pending Bills</h1>
          <p className="text-sm text-slate-500 mt-1">Consolidate costs from Reception, Pharmacy, Lab, and generate final invoices.</p>
        </div>
      </div>
                            ...
                            <tr key={item.id} className="hover:bg-slate-50">
                              <td className="py-3 px-4">
                                <span className={`px-2 py-1 rounded-md text-xs font-semibold ${
                                  ...
                                  item.department === 'RECEPTION' ? 'bg-indigo-100 text-indigo-700' :
