      ...
      `}>
        <div className="p-4 border-b border-slate-800 flex justify-between items-center bg-slate-950">
          <div className="flex items-center gap-3">
            ...
            <span className="font-bold text-xl text-white tracking-tight">Lab<span className="text-cyan-400">Tech</span></span>
          </div>
        ...
        <div className="p-6 border-t border-slate-800 bg-slate-950">
          <div className="bg-slate-800 rounded-xl p-4 flex items-center gap-3 mb-3">
            ...
            <div className="flex-1 min-w-0">
              <p className="text-sm font-semibold text-white truncate">Lab Technician</p>
        ...
        <header className="bg-white border-b border-slate-200 px-4 sm:px-6 lg:px-8 py-4 flex items-center justify-between sticky top-0 z-30">
          <div className="flex items-center gap-3">
            ...
            <div className="flex items-center gap-2 lg:hidden">
              ...
              <span className="font-bold text-slate-900">Lab<span className="text-cyan-600">Tech</span></span>
            </div>
          ...
          <div className="flex items-center gap-2">
            ...
            <div className="hidden sm:flex items-center gap-2 pl-2 border-l border-slate-200 ml-1">
              ...
              <div className="hidden md:block">
                <p className="text-sm font-semibold text-slate-900 leading-tight">Lab Technician</p>
